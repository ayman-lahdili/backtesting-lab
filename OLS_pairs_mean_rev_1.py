        ...
        for bar in range(lookback, data[S1].shape[0]):
            ...
            if S1_position == 0:
                if z_score_t < -threshold:
                    ...
                    print('am', self.amount)
                    print('net', self.net_wealth)
                    # print('net1: ', self.amount)
                    S1_position = 1
                    if S2_position == 1:
                        # self.place_sell_order(S2, bar, amount=self.amount/2)
                        # print('net2: ', self.amount)
                        S2_position = 0
            ...
            if S1_position == 1:
                if z_score_t > threshold:
                    ...
                    S1_position = 0
                    if S2_position == 0:
                        # self.place_buy_order(S2, bar, amount=self.amount)
                        S2_position = 1
